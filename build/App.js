...
import { ClerkProvider, SignedIn, SignedOut, RedirectToSignIn, SignIn, SignUp, SignInButton, } from "@clerk/clerk-react";
...
export default function App() {
    ...
    let element = useRoutes([
        {
            path: "/",
            element: (_jsxs("div", { children: [_jsx("div", { className: " text-red-200 ", children: "Welcome to the BoulyPokerTour, this app in alpha version so be nice please " }), _jsx(SignInButton, { children: "Deconnexion" }), _jsx("img", { src: bourlyimage, alt: "pokercouv", className: "w-1/2", style: { display: 'block', marginLeft: 'auto', marginRight: 'auto' } })] })),
        },
        {
            path: "/partypage",
