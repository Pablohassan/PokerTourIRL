...
const SelectPlayersGame = ({ setSelectedTournamentId, selectedTournamentId, championnat, players, selectedPlayers, handlePlayerSelect, onStartGame }) => {
    ...
    return (_jsx(Modal, { style: { height: "750px" }, isOpen: isOpen, isDismissable: true, closeButton: true, children: _jsxs(ModalContent, { children: [_jsx(ModalHeader, { children: " Nouvelle Partie:" }), _jsxs(ModalBody, { children: [_jsx("div", { children: !noTournaments ? (_jsxs("select", { value: selectedTournamentId ?? "", onChange: (e) => handleTournamentChange(Number(e.target.value)), children: [_jsx("option", { value: "", disabled: true, children: "Selectionne un tournois" }), championnat.map((tournament) => (_jsxs("option", { value: tournament.id, children: ["Pitch Poker Tour ", tournament.year] }, tournament.id)))] })) : (_jsx("p", { children: "No tournaments available. A new tournament will be created automatically." })) }), _jsx(ModalHeader, { children: "Selection des Joueurs" }), _jsxs(Table, { style: { height: "400px" }, children: [_jsxs(TableHeader, { children: [_jsx(TableColumn, { children: "Nom" }), _jsx(TableColumn, { children: "Joueur" })] }), _jsx(TableBody, { children: players.map((player) => (_jsxs(TableRow, { children: [_jsx(TableCell, { children: _jsx(Switch, { size: "sm", onChange: () => handlePlayerChange(player.id) }) }), _jsxs(TableCell, { children: [" ", _jsx("div", { className: 'text-lg', children: player.name }), " "] })] }, player.id))) })] }), _jsxs("div", { children: [_jsx(Button, { className: 'p-4 m-4', variant: 'bordered', onClick: () => onClose(), children: "Cancel" }), _jsx(Button, { color: 'success', className: 'p-4 m-4', onClick: handleStartGame, children: "Start Game" })] })] }), _jsx(ModalFooter, {})] }) }));
};
