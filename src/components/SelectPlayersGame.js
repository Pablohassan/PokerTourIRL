...
const SelectPlayersGame = ({ setSelectedTournamentId, selectedTournamentId, championnat, players, selectedPlayers, handlePlayerSelect, onStartGame }) => {
    ...
    return (_jsx(Modal, { style: { height: "950px" }, isOpen: isOpen, isDismissable: true, closeButton: true, children: _jsxs(ModalContent, { children: [_jsx(ModalHeader, { children: " Nouvelle Partie:" }), _jsxs(ModalBody, { children: [_jsx("div", { children: !noTournaments ? (_jsx("div", { children: _jsx(Select, { style: { color: "green" }, isRequired: true, label: "Tournois", className: "max-w-xs", selectedKeys: value, value: selectedTournamentId ?? "", onChange: (e) => handleTournamentChange(Number(e.target.value)), children: championnat.map((tournament) => (_jsxs(SelectItem, { value: tournament.id, children: ["Pitch Poker Tour ", tournament.year] }, tournament.id))) }) })) : (_jsx("p", { children: "No tournaments available. A new tournament will be created automatically." })) }), _jsx(ModalHeader, { children: "Selection des Joueurs" }), _jsxs(Table, { style: { height: "400px" }, children: [_jsxs(TableHeader, { children: [_jsx(TableColumn, { children: "Nom" }), _jsx(TableColumn, { children: "Joueur" })] }), _jsx(TableBody, { children: players.map((player) => (_jsxs(TableRow, { children: [_jsx(TableCell, { children: _jsx(Switch, { size: "sm", onChange: () => handlePlayerChange(player.id) }) }), _jsxs(TableCell, { children: [" ", _jsx("div", { className: 'text-lg', children: player.name }), " "] })] }, player.id))) })] }), _jsxs("div", { className: 'bg-[length:200px_100px]  bg-black', children: [_jsx(Button, { style: { margin: "2px", fontWeight: "bolder", }, variant: 'bordered', color: 'warning', onClick: () => onClose(), children: "Cancel" }), _jsx(Button, { color: 'success', style: { margin: "2px", fontWeight: "bolder" }, onClick: handleStartGame, children: "Start Game" })] })] }), _jsx(ModalFooter, {})] }) }));
};
