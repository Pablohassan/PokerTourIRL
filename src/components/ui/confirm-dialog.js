...
const ConfirmDialog = ({ isOpen, onClose, onConfirm, title, description, confirmText = "Confirm", cancelText = "Cancel", variant = 'default' }) => {
    ...
    return (_jsx(Dialog, { open: isOpen, onOpenChange: onClose, children: _jsxs(DialogContent, { className: cn(styles.bg, styles.border, "border-2", "backdrop-blur-md", "shadow-lg shadow-black/25", "max-w-[90vw] sm:max-w-[600px]", "p-6"), children: [_jsxs(DialogHeader, { className: "space-y-3", children: [_jsx(DialogTitle, { className: cn("font-['DS-DIGI']", "text-3xl sm:text-4xl", "text-center", styles.textColor, "tracking-wider", "font-bold"), children: title }), description && (_jsx(DialogDescription, { className: cn("text-center", styles.descriptionColor, "font-['DS-DIGI']", "text-xl", "leading-relaxed"), children: description }))] }), _jsxs(DialogFooter, { className: "flex gap-4 justify-end mt-8", children: [_jsx(Button, { variant: "default", onClick: onClose, className: cn("border-2", styles.cancelBtn, "font-['DS-DIGI']", "text-white", "text-lg", "px-6 py-2", "transition-all duration-200", "hover:scale-105", "active:scale-95"), children: cancelText }), _jsx(Button, { onClick: handleConfirm, className: cn(styles.confirmBtn, "font-['DS-DIGI']", "border border-black", "text-lg", "px-6 py-2", "transition-all duration-200", "hover:scale-105", "active:scale-95", "border-0"), children: confirmText })] })] }) }));
};
