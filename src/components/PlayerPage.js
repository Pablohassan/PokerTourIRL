...
export const PlayerPage = () => {
    ...
    return (_jsx("div", { className: "p-5 min-h-screen bg-slate-900", children: isLoading ? (_jsx("div", { className: "flex justify-center items-center min-h-[50vh]", children: _jsx("div", { className: "text-amber-400 text-xl", children: "Loading player data..." }) })) : error ? (_jsx("div", { className: "flex justify-center items-center min-h-[50vh]", children: _jsx("div", { className: "text-red-500 text-xl", children: error }) })) : playerStats ? (_jsxs("div", { children: [_jsx("h1", { className: "text-2xl font-bold text-amber-400 mb-6", children: playerStats.name }), _jsxs("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-4 mb-8", children: [_jsx(StatCard, { title: "Total Points", value: playerStats.totalPoints }), _jsx(StatCard, { title: "Wins", value: playerStats.winCount }), _jsx(StatCard, { title: "Profit/Loss", value: `${playerStats.totalGains >= 0 ? '+' : ''}${playerStats.totalGains.toFixed(2)} €`, className: playerStats.totalGains >= 0 ? "border-green-500/30" : "border-red-500/30" }), _jsx(StatCard, { title: "Avg Position", value: playerStats.averagePosition.toFixed(1) })] }), _jsx(Tabs, { value: activeYear ? activeYear.toString() : "", onValueChange: (value) => {
