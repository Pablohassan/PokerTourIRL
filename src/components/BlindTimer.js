...
const BlindTimer = ({ gameStarted, isPaused, onBlindChange, onTimeChange, blindIndex, setBlindIndex, initialTimeLeft }) => {
    ...
    return (_jsxs(_Fragment, { children: [playAlert && _jsx("audio", { src: alerteSon, autoPlay: true }), _jsx(Dialog, { open: showModal, onOpenChange: setShowModal, children: _jsxs(DialogContent, { className: cn("bg-slate-900/95 border-amber-400/20", "backdrop-blur-md", "shadow-[0_0_25px_-5px_rgba(245,158,11,0.2)]", "max-w-[90vw] sm:max-w-[400px]", "p-3 sm:p-4"), children: [_jsx(DialogHeader, { children: _jsx(DialogTitle, { className: cn("font-['DS-DIGI'] text-2xl sm:text-3xl text-center", "text-amber-400", "tracking-wider"), children: "New Blind Level" }) }), _jsxs("div", { className: "font-['DS-DIGI'] text-xl sm:text-2xl text-center space-y-2 py-2 sm:py-4", children: [_jsxs("div", { className: "flex justify-between px-4 sm:px-8", children: [_jsx("span", { className: "text-amber-400/80", children: "Small Blind" }), _jsx("span", { className: "text-amber-400", children: blinds[blindIndex].small })] }), _jsxs("div", { className: "flex justify-between px-4 sm:px-8", children: [_jsx("span", { className: "text-amber-400/80", children: "Big Blind" }), _jsx("span", { className: "text-amber-400", children: blinds[blindIndex].big })] }), _jsx("div", { className: "h-px bg-amber-400/20 mx-4 sm:mx-8 my-2 sm:my-4" }), _jsxs("div", { className: "flex justify-between px-4 sm:px-8", children: [_jsx("span", { className: "text-amber-400/80", children: "Ante" }), _jsx("span", { className: "text-amber-400", children: blinds[blindIndex].ante })] })] })] }) })] }));
};
