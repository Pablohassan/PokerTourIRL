...
const BlindTimer = ({
  ...
  return _jsxs(_Fragment, {
    children: [
      playAlert && _jsx("audio", { src: alerteSon, autoPlay: true }),
                ...
                children: [
                    ...
                    children: _jsxs(motion.div, {
                      ...
                      children: [
                        _jsx(DialogTitle, {
                          ...
                          children: "Blind Change!",
                        }),
                        _jsx("p", {
                          className:
                            "text-amber-400/80 text-center text-lg sm:text-xl font-['DS-DIGI']",
                          children: "New blinds for next hand",
                        }),
                      ],
                    }),
                  }),
                  _jsxs(motion.div, {
                    ...
                    children: [
                      _jsx("div", {
                        className:
                          "bg-zinc-900/80 rounded-xl p-4 sm:p-6 border border-amber-500/20",
                        children: _jsxs("div", {
                          className: "space-y-4",
                          children: [
                            _jsxs(motion.div, {
                              ...
                              children: [
                                _jsx("span", {
                                  className:
                                    "font-['DS-DIGI'] text-amber-400/80 text-2xl sm:text-3xl",
                                  children: "Small Blind",
                                }),
                                _jsx("span", {
                                  className:
                                    "font-['DS-DIGI'] text-amber-400 text-3xl sm:text-4xl",
                                  children: displayBlinds.small,
                                }),
                              ],
                            }),
                            _jsxs(motion.div, {
                              ...
                              children: [
                                ...
                                _jsx("span", {
                                  className:
                                    "font-['DS-DIGI'] text-amber-400 text-3xl sm:text-4xl",
                                  children: displayBlinds.big,
                                }),
                              ],
                            }),
                            _jsx("div", {
                              className: "h-px bg-amber-400/20 my-4",
                            }),
                            _jsxs(motion.div, {
                              className: "flex justify-between items-center",
                              initial: { x: -20, opacity: 0 },
                      ...
                      _jsx(motion.div, {
                        className:
                          "text-center text-amber-400/60 text-sm sm:text-base font-['DS-DIGI']",
                        initial: { opacity: 0 },
                        animate: { opacity: 1 },
