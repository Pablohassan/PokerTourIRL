      ...
      <Card style={cardStyle}>
        <div style={{ display: 'flex' }}>
          <div style={sectionStyle}>
            <h3 style={headerStyle}>Joueurs inscrits</h3>
            <Spacer y={1} />
            ...
            <div style={{ display: 'flex', justifyContent: 'flex-end', margin: "5px" }}>
              <Button color="primary" onClick={onConfirm}>Confirm and Start Game</Button>
              <Spacer x={1} />
              <Button color="primary" onClick={() => navigate("/partypage")}>Back</Button>
            </div>
          </div>
          <div style={sectionStyle}>
